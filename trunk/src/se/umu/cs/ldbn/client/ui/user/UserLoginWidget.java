...
public class UserLoginWidget extends Composite implements ClickListener {
	...
	private HorizontalPanel userHP;
	//pass
	private PasswordTextBox passTB;
	private Label passLabel;
	private HorizontalPanel passHP;
	//login
	...
	public UserLoginWidget() {
		...
		userHP = new HorizontalPanel();
		userHP.setVerticalAlignment(HasVerticalAlignment.ALIGN_MIDDLE);
		userHP.add(userLabel);
		userHP.add(userTB);
		mainPanel.add(userHP);
		//pass
		passTB = new PasswordTextBox();
		passLabel = new Label("Password: ");
		passHP = new HorizontalPanel();
		passHP.setVerticalAlignment(HasVerticalAlignment.ALIGN_MIDDLE);
		passHP.add(passLabel);
		passHP.add(passTB);
		mainPanel.add(passHP);
		//logout
