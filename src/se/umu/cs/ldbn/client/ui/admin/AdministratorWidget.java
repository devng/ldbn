...
public final class AdministratorWidget extends AbsolutePanel 
	implements ClickListener, LoginListener, LoadAssignmentDialogCallback {
	...
	private AdministratorWidget() {
		...
		addToAdmin.addClickListener(this);
		hw.add(addToAdmin);
		
		removeFromAdmin = new Button("Remove Administrators");
		removeFromAdmin.addClickListener(this);
		...
		deleteAssignment.addClickListener(this);
