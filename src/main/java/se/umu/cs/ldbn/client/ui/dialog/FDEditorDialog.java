...
public final class FDEditorDialog extends CloseDialog {
	...
	public void hide() {
		...
		ClientMain.get().getDragController().unregisterDropController(fdew.getRightTextArea());
		ClientMain.get().getDragController().unregisterDropController(fdew.getLeftTextArea());
	...
	public void show() {
		super.show();
		ClientMain.get().getDragController().registerDropController(fdew.getRightTextArea());
		ClientMain.get().getDragController().registerDropController(fdew.getLeftTextArea());
	}
