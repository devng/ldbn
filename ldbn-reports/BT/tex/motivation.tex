...
Department of Computing Science at Umeå University, and some important 
...
\begin{figure}[h]
	\begin{center}
		\includegraphics[width=0.8\textwidth]{./img/example_fds_01.png}
		\caption{Typical Representation of FDs}
...
This collaborative approach has been inspired by the Wikipedia project.
However, during the testing period the system has been flooded with assignments, 
which occurred more than once under different names, which were usually submitted 
